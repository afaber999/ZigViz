...
const fcolor = Canvas.from_rgba(0x50, 0xFF, 0x50, 0xFF);

const Self = @This();

pub fn init(allocator: std.mem.Allocator, width: i32, height: i32) !Self {
    log("INIT wireframe3d from ZIG... {d} {d}\n", .{ width, height });
...
// pub fn draw_point(self: *Self, point: Canvas.Point, color: Canvas.PixelType) void {
//     self.canvas.fill_circle(point.x, point.y, 20, color);
// }
...
pub fn render(self: *Self, dt: f32) bool {
    ...
    self.canvas.fill_circle(100, 100, 20, fcolor);

    //draw_point(self: *Self, point: Canvas.Point, color: Canvas.PixelType) void {
